...
- Librairie Guava
- jsoup
- Autres (Java 9, Scanner, Apache Commons)
...
&#8203;<Highlight color="tip">0,5 point</Highlight> La classe principale s'appelle KotCrawlerDupont.java

&#8203;<Highlight color="tip">0,5 point</Highlight> Le package de l'application est crawly.dupont
