...
Si tu n'arrive pas à naviguer vers [l'écran de vote](#activité-3---écran-de-vote-dune-question) et de [création de tâche](#activité-4---écran-de-résultats-dune-question) à partir d'un élément de liste, tu peux ajouter des boutons sous pour t'y rendre directement. Nous pourrons au moins te donner des points pour ces activités.
