...
<Tabs queryString="recette-string">
  ...
  <TabItem value="mon_item.xml" label="mon_item.xml">
    ...
    ![Create item xml](_01-recycler-view/create_item_xml.png)
    ...
    ![Create item xml 2](_01-recycler-view/create_item_xml2.png)
  ...
  <TabItem value="MonAdapter.kt" label="MonAdapter.kt">
    ...
    ![Recette créer mon adapter](_01-recycler-view/recette_creer_mon_adapter.png)
    ...
    <details>
      ...
      ![Implementer ListAdapter](_01-recycler-view/implementer_listadapter.png)
    </details>
...
```
  ...
  <TabItem value="problemes-frequents" label="Problèmes fréquents">
    ...
    <details>
      ...
      <Row>
        <Column size="3" >
          ![Problem item height](_01-recycler-view/problem_item_height.png)
        </Column>
      </Row>
